...
namespace PMIU.WRMIS.Web.Modules.DailyData
{
    public partial class OutletPerformanceHistory : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    bool HasRights = new DailyDataBLL().HasPageRights(LoggedUser, "/Modules/DailyData/OutletPerformanceHistory.aspx");
        ...
        {
            Tuple<string, string, string> pageTitle = base.SetPageTitle(PageName.OutletPerformanceHistory);
        ...
        public void ParentInformation()
        {
            try
            {
                ...
                object parentInfo = new DailyDataBLL().OutletHistoryInformation(ChannelID);
