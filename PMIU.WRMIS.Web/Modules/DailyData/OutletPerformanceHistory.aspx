<%@ Page Title="Outlet Performance Data" MasterPageFile="~/Site.Master" Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="OutletPerformanceHistory.aspx.cs" Inherits="PMIU.WRMIS.Web.Modules.DailyData.OutletPerformanceHistory" %>
        ...
        <div class="col-md-12">
            <div class="box">
                ...
                <div class="box-content" id="divMain" runat="server">
                    ...
                    <div class="table-responsive">
                        <asp:GridView ID="gvOutletshistory" runat="server" AutoGenerateColumns="False" EmptyDataText="No record is found for the given dates"
