<%@ Page Title="Roles" MasterPageFile="~/Site.Master" Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="SearchCriteriaForOutletPerformance.aspx.cs" Inherits="PMIU.WRMIS.Web.Modules.DailyData.SearchCriteriaForOutletPerformance" %>
                                ...
                                <asp:GridView ID="gvChannels" runat="server" AutoGenerateColumns="False" EmptyDataText="No Channel is found for the given criteria"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Channel Outlets in Sections">
                                            <ItemTemplate>
                                                <asp:HyperLink ID="hlAssociation" runat="server" CssClass="btn btn-primary btn_24 outlet" ToolTip="Outlets" NavigateUrl='<%# String.Format("~/Modules/DailyData/CriteriaForSpecificOutlet.aspx?ChannelID={0}", Convert.ToString(Eval("ID"))) %>'></asp:HyperLink>
                                            </ItemTemplate>
                                            <HeaderStyle CssClass="col-md-2" />
                                        </asp:TemplateField>
