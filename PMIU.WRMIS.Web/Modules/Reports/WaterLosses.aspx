<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="WaterLosses.aspx.cs" Inherits="PMIU.WRMIS.Web.Modules.Reports.WaterLosses" %>
                ...
                <ContentTemplate>
                    <div class="row">
                        ...
                        <div class="col-md-1" style="text-align:right;">
                            <div class="fnc-btn">
                                <asp:Button runat="server" ID="btnSeasonalPlanningReport" OnClick="btnWaterLossesReport_Click" CssClass="btn btn-primary" Text="View" />
                            </div>
                        </div>
                    </div>
