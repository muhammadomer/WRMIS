<%@ Page Title="ContractorsAttendance" MasterPageFile="~/Site.Master" EnableEventValidation="false" Language="C#" AutoEventWireup="true" CodeBehind="AddContractorsAttendance.aspx.cs" Inherits="PMIU.WRMIS.Web.Modules.Tenders.Works.AddContractorsAttendance" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="col-md-12">
        <div class="box">
            <div class="box-title">
                <h3 id="htitle" runat="server">Contractors Attendance</h3>
            </div>
          ...
          <div id="divPanel" class="panel panel-default" runat="server">
                    <div id="Tabs" role="tabpanel">
                        <!-- Nav tabs -->
                            ...
                            <li id="liContractor" style="width: 20%; text-align: center" runat="server" class="active"><a id="anchContractor" runat="server" aria-controls="ContractorsAttendance" role="tab">Contractors Attendance</a></li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <asp:GridView ID="gvContractorsAttendance" runat="server" AutoGenerateColumns="False" EmptyDataText="No Record Found"
                                ShowHeaderWhenEmpty="True" CssClass="table header" BorderWidth="0px" CellSpacing="-1" GridLines="None" AllowPaging="True"
                                DataKeyNames="AttendanceID" OnRowDataBound="gvContractorsAttendance_RowDataBound">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Company Name">
                                        <ItemTemplate>
                                            <asp:Label ID="lblCompanyName" runat="server" CssClass="control-label" Text='<%# Eval("CompanyName") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Contractor Name">
                                        ...
                                        <ItemTemplate>
                                            <asp:TextBox runat="server" ID="txtAlternateName" required="required" type="text" class="form-control" Text='<%# Eval("AlternateName") %>' ClientIDMode="Static" disabled="disabled"> </asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Remarks">
                                        ...
                                        <ItemTemplate>
                                            <asp:TextBox runat="server" ID="txtAlternateRemarks" type="text" class="form-control" Text='<%# Eval("AlternateRemarks") %>' ClientIDMode="Static" disabled="disabled"> </asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
    ...
    <script type="text/javascript">
        ...
        function CheckAll(Checkbox) {
            var GridVwHeaderCheckbox = document.getElementById("<%=gvContractorsAttendance.ClientID %>");
