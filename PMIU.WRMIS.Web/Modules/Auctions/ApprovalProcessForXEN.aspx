<%@ Page Title="ApprovalProcess" MasterPageFile="~/Site.Master" EnableEventValidation="false" Language="C#" AutoEventWireup="true" CodeBehind="ApprovalProcessForXEN.aspx.cs" Inherits="PMIU.WRMIS.Web.Modules.Auctions.ApprovalProcessForXEN" %>
                                ...
                                <ItemStyle CssClass="text-right padding-right-number" />
                                 ...
                                 <asp:TemplateField HeaderText="Status">
                                    ...
                                    <asp:TemplateField HeaderText="Update Delivery Status">
                                        ...
                                        <ItemTemplate>
                                            <asp:Button ID="btnDelivery" runat="server" Text="" CommandName="Delivery" CssClass="btn btn-primary btn_24 tenderworks" ToolTip="Update Delivery" formnovalidate="formnovalidate" />
                                            <asp:Button ID="BtnApprovalStatus" runat="server" Text="" CommandName="Status" CssClass="btn btn-primary btn_24 tenderopenprocess" ToolTip="Approval Details" formnovalidate="formnovalidate" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
