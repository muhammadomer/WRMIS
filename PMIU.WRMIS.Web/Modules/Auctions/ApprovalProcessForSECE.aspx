<%@ Page Title="ApprovalProcess" MasterPageFile="~/Site.Master" EnableEventValidation="false" Language="C#" AutoEventWireup="true" CodeBehind="ApprovalProcessForSECE.aspx.cs" Inherits="PMIU.WRMIS.Web.Modules.Auctions.ApprovalProcessForSECE" %>
                                ...
                                <ItemStyle CssClass="text-right padding-right-number" />
                                 ...
                                 <asp:TemplateField HeaderText="Status">
                                    ...
                                    <asp:TemplateField HeaderText="Update Status">
                                        ...
                                        <ItemTemplate>
                                            <asp:Button ID="btnStatus" runat="server" Text="" CommandName="Status" CssClass="btn btn-primary btn_24 tenderworks" ToolTip="Update Status" formnovalidate="formnovalidate" />
                                            <asp:Button ID="btnDeliverDetails" runat="server" Text="" CommandName="Delivery" CssClass="btn btn-primary btn_24 tenderopenprocess" ToolTip="Delivery Details" formnovalidate="formnovalidate" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
