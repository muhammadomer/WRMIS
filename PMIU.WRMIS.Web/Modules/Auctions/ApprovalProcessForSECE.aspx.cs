...
{
    public partial class ApprovalProcessForSECE : BasePage
    {
        ...
        protected void gvApprovalProcess_OnRowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    Button btnDeliverDetails = (Button)e.Row.FindControl("btnDeliverDetails");
                    ...
                    if (Status == "Pending" || Status == null)
                    {
                        btnDeliverDetails.Visible = false;
                    }
        ...
        protected void gvApprovalProcess_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                else if (e.CommandName == "Delivery")
                {
