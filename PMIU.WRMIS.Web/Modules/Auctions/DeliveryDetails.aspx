<%@ Page Title="DeliveryDetails" MasterPageFile="~/Site.Master" EnableEventValidation="false" Language="C#" AutoEventWireup="true" CodeBehind="DeliveryDetails.aspx.cs" Inherits="PMIU.WRMIS.Web.Modules.Auctions.DeliveryDetails" %>
                ...
                <div class="form-horizontal">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                         ...
                         <div class="col-md-6">
                        <div class="form-group">
                            <label class="col-sm-4 col-lg-3 control-label">Approval Authority Remarks</label>
                            <div class="col-sm-8 col-lg-9 controls">
                                <asp:TextBox ID="txtApprovalAuthRemarks" runat="server" CssClass="form-control commentsMaxLengthRow multiline-no-resize" TabIndex="2" TextMode="MultiLine" Rows="5" MaxLength="250" ReadOnly="true"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                        </div>
