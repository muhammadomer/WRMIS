<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="ClosureWorkType.aspx.cs" Inherits="PMIU.WRMIS.Web.Modules.ClosureOperations.RefrenceData.ClosureWorkType" EnableEventValidation="false"  %> 
                        ...
                        <asp:GridView ID="gv" runat="server" AutoGenerateColumns="false" AllowPaging="true" PageSize="100"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="isActive" Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="lblOther" runat="server" CssClass="control-label" Text='<%# Eval("IsOther") %>' Visible="false"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>

                                <asp:TemplateField HeaderText="Closure Work Type" Visible="true">
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtName" runat="server" required="required" MaxLength="30" onfocus="this.value = this.value;" CssClass="form-control required" placeholder="Enter Closure Work Type" value='<%# Eval("Name") %>' Width="90%"/>
                                    </EditItemTemplate>
                                </asp:TemplateField>
