...
namespace PMIU.WRMIS.Web.Modules.ClosureOperations.RefrenceData
{
    public partial class ClosureWorkType : BasePage
    {
        //Data Members 
        Dictionary<string, object> workTypeData = new Dictionary<string, object>();
        List<CW_WorkType> lstWorkType = new List<CW_WorkType>();
        ...
        protected void gv_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            try
            {
                ...
                if (bllCO.ClosureWorkTypeAssiciatExists(id))
                ...
                if ((bool)bllCO.ClosureWorkType_Operations(Constants.CRUD_DELETE, workTypeData))
                {
        ...
        protected void gv_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            { 
                ...
                CW_WorkType mdlWork = (CW_WorkType)bllCO.ClosureWorkType_Operations(Constants.CRUD_READ, workTypeData);
                ...
                if (id == 0)
                {
                    status = (bool)bllCO.ClosureWorkType_Operations(Constants.CRUD_CREATE, workTypeData);
                }
                else
                {
                    status = (bool)bllCO.ClosureWorkType_Operations(Constants.CRUD_UPDATE, workTypeData);
                }
        ...
        protected void gv_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                ...
                {
                    Button btnDelete = (Button)e.Row.FindControl("btnDelete");
                    Label lblIsActiv = (Label)e.Row.FindControl("lblOther");
                    if (btnDelete!= null && lblIsActiv.Text.ToString().ToLower().Equals("false"))
        ...
        {
            Tuple<string, string, string> pageTitle = base.SetPageTitle(PageName.ClosureWorkType);
