<%@ Page Title="PhysicalLocation" MasterPageFile="~/Site.Master" EnableEventValidation="false" Language="C#" AutoEventWireup="true" CodeBehind="DrainPhysicalLocation.aspx.cs" Inherits="PMIU.WRMIS.Web.Modules.IrrigationNetwork.ReferenceData.Drain.DrainPhysicalLocation" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="box">
        <div class="box-title">
            <h3>Physical Location of Drain</h3>
            <div class="box-tool">
            ...
            <div class="table-responsive">
                <asp:UpdatePanel runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="gvIrrigationBoundaries" runat="server" DataKeyNames="ID,ZoneID,CircleID,DivisionID,SubDivisionID,SectionID,FromRDTotal,ToRDTotal,CreatedBy,CreatedDate"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Division">
                                    ...
                                    <EditItemTemplate>
                                        <asp:DropDownList ID="ddlDivision" runat="server" OnSelectedIndexChanged="ddlDivision_SelectedIndexChanged" required="required" CssClass="required form-control" Style="max-width: 90%;" AutoPostBack="True"></asp:DropDownList>
                                    </EditItemTemplate>
                                    <ItemStyle Width="150px" />
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Section">
                                    ...
                                    <EditItemTemplate>
                                        <asp:DropDownList ID="ddlSection" runat="server" required="required" CssClass="required form-control" Style="max-width: 90%;" AutoPostBack="True"></asp:DropDownList>
                                    </EditItemTemplate>
                                    <ItemStyle Width="150px" />
                                </asp:TemplateField>

                                <asp:TemplateField HeaderText="From R.D">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="To R.D">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <asp:Panel ID="pnlActionIrrigationBoundaries" runat="server" HorizontalAlign="Center">
                                            ...
                                            <asp:Button ID="btnDeleteIrrigationBoundaries" runat="server" Text="" CommandName="Delete" Visible="<%# base.CanDelete %>" OnClientClick="return confirm('Are you sure you want to delete this record?');" CssClass="btn btn-danger btn_24 delete" ToolTip="Delete" formnovalidate="formnovalidate" />
                                        </asp:Panel>
                                    </ItemTemplate>
                                    <EditItemTemplate>
