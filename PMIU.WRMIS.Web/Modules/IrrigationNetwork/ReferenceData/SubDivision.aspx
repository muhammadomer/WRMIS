<%@ Page Title="Sub Division" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SubDivision.aspx.cs" Inherits="PMIU.WRMIS.Web.Modules.IrrigationNetwork.ReferenceData.SubDivision" EnableEventValidation="false" %>
                ...
                <div class="box-content">
                    ...
                    <div class="table-responsive">
                        <asp:GridView ID="gvSubDivision" runat="server" AutoGenerateColumns="False" EmptyDataText="No record found"
                            ShowHeaderWhenEmpty="True" OnRowCommand="gvSubDivision_RowCommand"
                            OnRowCancelingEdit="gvSubDivision_RowCancelingEdit" OnRowUpdating="gvSubDivision_RowUpdating"
                            OnRowEditing="gvSubDivision_RowEditing" OnRowDeleting="gvSubDivision_RowDeleting" AllowPaging="True"
                            OnPageIndexChanging="gvSubDivision_PageIndexChanging" CssClass="table header"
                            BorderWidth="0px" CellSpacing="-1" GridLines="None" Visible="false" OnPageIndexChanged="gvSubDivision_PageIndexChanged">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Sub Division Name">
                                    <ItemTemplate>
                                        <asp:Label ID="lblSubDivisionName" CssClass="control-label" runat="server" Text='<%# Eval("Name") %>'></asp:Label>
                                    </ItemTemplate>
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtName" runat="server" CssClass="form-control required" required="true" MaxLength="75" placeholder="Enter Sub Division Name" Text='<%# Eval("Name") %>' Width="90%" onfocus="this.value = this.value;" onkeyup="InputValidation(this)" ClientIDMode="Static" />
                                    </EditItemTemplate>
                                    <HeaderStyle CssClass="col-md-3" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Description">
                                    <ItemTemplate>
                                        <asp:Label ID="lblSubDivisionDesc" runat="server" CssClass="control-label" Text='<%# Eval("Description") %>'></asp:Label>
                                    </ItemTemplate>
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtDesc" runat="server" CssClass="form-control" MaxLength="150" placeholder="Enter Sub Division Description" Text='<%# Eval("Description") %>' Width="90%" />
                                    </EditItemTemplate>
