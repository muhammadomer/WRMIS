<%@ Page Title="Circle" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Circle.aspx.cs" Inherits="PMIU.WRMIS.Web.Modules.IrrigationNetwork.ReferenceData.Circle" EnableEventValidation="false" %>
                ...
                <div class="box-content">
                    ...
                    <div class="table-responsive">
                        <asp:GridView ID="gvCircle" runat="server" AutoGenerateColumns="False" EmptyDataText="No record found"
                            ShowHeaderWhenEmpty="True" OnRowCommand="gvCircle_RowCommand"
                            OnRowCancelingEdit="gvCircle_RowCancelingEdit" OnRowUpdating="gvCircle_RowUpdating"
                            OnRowEditing="gvCircle_RowEditing" OnRowDeleting="gvCircle_RowDeleting" AllowPaging="True"
                            OnPageIndexChanging="gvCircle_PageIndexChanging" CssClass="table header"
                            BorderWidth="0px" CellSpacing="-1" GridLines="None" Visible="false" OnPageIndexChanged="gvCircle_PageIndexChanged">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Circle Name">
                                    <ItemTemplate>
                                        <asp:Label ID="lblCircleName" runat="server" CssClass="control-label" Text='<%# Eval("Name") %>'></asp:Label>
                                    </ItemTemplate>
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtName" runat="server" CssClass="form-control required" required="true" MaxLength="30" placeholder="Enter Circle Name" Text='<%# Eval("Name") %>' Width="90%" onfocus="this.value = this.value;" onkeyup="InputValidation(this)" ClientIDMode="Static" />
                                    </EditItemTemplate>
                                    <HeaderStyle CssClass="col-md-3" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Description">
                                    <ItemTemplate>
                                        <asp:Label ID="lblCircleDesc" runat="server" CssClass="control-label" Text='<%# Eval("Description") %>'></asp:Label>
                                    </ItemTemplate>
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtDesc" runat="server" CssClass="form-control" MaxLength="100" placeholder="Enter Circle Description" Text='<%# Eval("Description") %>' Width="90%" />
                                    </EditItemTemplate>
