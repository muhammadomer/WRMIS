...
{
    public partial class ViewBedLevelDTParameters : BasePage
    {
        ...
        {
            Tuple<string, string, string> pageTitle = base.SetPageTitle(PageName.ViewBedLevelDTHistory);
        ...
        private void BindGrid()
        {
            ...
            List<CO_ChannelGaugeDTPGatedStructure> lstParameterHistory = new ChannelBLL().GetBedLevelParameterHistory(FromDate, ToDate, GaugeID);
        ...
        protected void gvHistory_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                  ...
                  //  DateTime DateOfApproval = DateTime.Parse(lblDateOfApproval.Text);
                    ...
                    Label lblGaugeCorrectionType = (Label)e.Row.FindControl("lblGaugeCorrectionType");

                    if (lblGaugeCorrectionType.Text != String.Empty)
                    {
                        bool CorrectionType = Convert.ToBoolean(lblGaugeCorrectionType.Text);

                        if (CorrectionType == Constants.GaugeCorrectionScouredType)
                        {
                            lblGaugeCorrectionType.Text = "Bed Scoured";
                        }
                        else
                        {
                            lblGaugeCorrectionType.Text = "Bed Silted";
                        }
                    }
        ...
        protected void btnDischargeTable_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                mdlReportData.Name = Constants.DischargeTableBedReport;
