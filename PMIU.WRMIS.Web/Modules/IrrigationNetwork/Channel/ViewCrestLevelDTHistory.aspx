<%@ Page Title="View Crest Level DT History" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewCrestLevelDTHistory.aspx.cs" Inherits="PMIU.WRMIS.Web.Modules.IrrigationNetwork.Channel.ViewCrestLevelDTHistory" EnableEventValidation="false" %>

<%@ MasterType VirtualPath="~/Site.Master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="box">
        <div class="box-title">
            <h3>Discharge Table Parameters for Crest Level Gauges History</h3>
        </div>
            ...
            <div class="table-responsive">
                <asp:GridView ID="gvHistory" runat="server" AutoGenerateColumns="False" EmptyDataText="No record found"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Head Above Crest (H in ft)" ItemStyle-CssClass="numberAlign">
                            <ItemTemplate>
                                <asp:Label ID="lblMeanDepth" runat="server" CssClass="control-label" Text='<%# Eval("HeadAboveCrest") %>'></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle CssClass="col-md-2" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Breadth of Fall (B in ft)" ItemStyle-CssClass="numberAlign">
                            <ItemTemplate>
                                <asp:Label ID="lblExponentValue" runat="server" CssClass="control-label" Text='<%# Eval("BreadthFall") %>'></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle CssClass="col-md-2" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Coefficient of Discharge (C)" ItemStyle-CssClass="numberAlign">
                            <ItemTemplate>
                                <asp:Label ID="lblDischargeCoefficient" runat="server" CssClass="control-label" Text='<%# Math.Round(Convert.ToDouble(Eval("DischargeCoefficient"))) %>'></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle CssClass="col-md-2" />
                        </asp:TemplateField>
