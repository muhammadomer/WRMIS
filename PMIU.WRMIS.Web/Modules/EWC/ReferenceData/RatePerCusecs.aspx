<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" EnableEventValidation="false" CodeBehind="RatePerCusecs.aspx.cs" Inherits="PMIU.WRMIS.Web.Modules.EWC.ReferenceData.RatePerCusecs" %>
                    ...
                    <asp:Panel ID="pnlEffluent" runat="server" GroupingText="Effluent">
                        <div class="table-responsive">
                            <table class="table tbl-info">
                                <tr>
                                    <th>
                                        <div><strong>Annual Rate (Rs./cusec)</strong></div>
                                    </th>
                                    <th>
                                ...
                                <tr>
                                    <td>
                                        <asp:HiddenField ID="hdfRate" runat="server" Value="" />
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="fnc-btn">
                                    <asp:Button ID="btnChange" runat="server" Text="Change" CssClass="btn btn-primary" ToolTip="Change" OnClick="btnChange_Click" formnovalidate="formnovalidate" />
                    ...
                    <asp:Panel ID="pnlCanal" runat="server" GroupingText="Canal Special Water">
                        <div class="table-responsive">
                            <table class="table tbl-info">
                                <tr>
                                    <th>
                                        <div><strong>Annual Rate (Rs./'000 Cft)</strong> </div>
                                    </th>
                                    <th>
                                        <div><strong>Last Update Date</strong> </div>
                                    </th>
                                ...
                                <tr>
                                    <td>
                                        <asp:HiddenField ID="hdfRateCanal" runat="server" Value="" />
                                        <asp:HiddenField ID="hdnAttachmentCanal" runat="server" Value="" />
                                        <asp:Label ID="lblRateCanal" runat="server"></asp:Label>
                                        <%--     <asp:Label ID="lblRateCanal" runat="server"></asp:Label>--%></td>
                                    <td>
                                        <asp:Label ID="lblDateCanal" runat="server"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <th>
                                                ...
                                                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                    <ContentTemplate>
                                                        <div id="divHistory" runat="server" class="table-responsive" visible="false">
                                                            <asp:GridView ID="gv" runat="server" AllowPaging="true" AutoGenerateColumns="false" BorderWidth="0px" CellSpacing="-1" CssClass="table header" EmptyDataText="No record found" GridLines="None" PageSize="50" ShowHeaderWhenEmpty="true"
                                                                DataKeyNames="Attachment" OnRowDataBound="gv_RowDataBound">
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="Date">
                                                                        <HeaderStyle CssClass="col-md-2" />
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblDate" runat="server" CssClass="control-label" Text='<%# Eval("ChargesDate") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="Annual Rate">
                                                                        <HeaderStyle CssClass="col-md-1 text-center" />
                                                                        <ItemStyle CssClass="text-right" />
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblName" runat="server" CssClass="control-label" Text='<%# Eval("Charges")%>'></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-8">
                                                                    <div class="form-group">
                                                                        <asp:Label ID="lblRateLabel" runat="server" CssClass="col-sm-4 col-lg-3 control-label" Text="Annual Rate (Rs./Cusecs)" />
                                                                        <div class="col-sm-8 col-lg-9 controls">
                                                                            <asp:TextBox ID="txtRate" runat="server" ClientIDMode="Static" CssClass="form-control required integerInput" MaxLength="5" required="required" TabIndex="1" />
                                                                        </div>
                                                                ...
                                                                <div class="col-md-8">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-sm-8 col-lg-9 controls">
                                                                            ...
                                                                            <asp:HyperLink ID="hlAtchmntEffulent" runat="server" Text="Attachment" Visible="false" />
                                                                        </div>
                                                                        <%--<div class="col-sm-8 col-lg-1 controls">Rs./Cusecs </div>--%>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <br />
                                                            <div class="row">
                                                                <div class="col-md-8">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-sm-8 col-lg-9 controls">
                                                                            <asp:TextBox ID="txtRmrks" MaxLength="50" runat="server"
                                                                                CssClass="form-control multiline-no-resize" Rows="5" TextMode="MultiLine"
                                                                                onkeyDown="checkTextAreaMaxLength(this,event,'50');" />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
