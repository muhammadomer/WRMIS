<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" EnableEventValidation="false"  CodeBehind="DschrgSuplySource.aspx.cs" Inherits="PMIU.WRMIS.Web.Modules.EWC.ReferenceData.DschrgSuplySource" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional" runat="server" RenderMode="Inline">
        <ContentTemplate>
            <div class="box">
                <div class="box-title">
                    <h3>Discharge/Supply Sources</h3> 
                </div>
                    ...
                    <div class="table-responsive">
                        <asp:GridView ID="gv" runat="server" AutoGenerateColumns="false" AllowPaging="true" PageSize="100"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Discharge/Supply Sources" Visible="true">
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtName" runat="server" required="required" MaxLength="30" onfocus="this.value = this.value;" CssClass="form-control required" placeholder="Enter Discharge/Supply Source" value='<%# Eval("Name") %>' Width="90%"/>
                                    </EditItemTemplate>
                                </asp:TemplateField>
