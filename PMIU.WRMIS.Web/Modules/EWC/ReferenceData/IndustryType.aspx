<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" EnableEventValidation="false" CodeBehind="IndustryType.aspx.cs" Inherits="PMIU.WRMIS.Web.Modules.EWC.ReferenceData.IndustryType" %>
                    ...
                    <div class="table-responsive">
                        <asp:GridView ID="gv" runat="server" AutoGenerateColumns="false" AllowPaging="true" PageSize="100"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Industry Type" Visible="true">
