...
{
    public partial class SearchCriteriaForOutletAlteration : BasePage 
    {
        ...
        {
            Tuple<string, string, string> pageTitle = base.SetPageTitle(PageName.SISearchCriteriaForOutletAlteration);
        ...
        {
            long ChannelID = Convert.ToInt64(((Label)gvChannels.Rows[e.NewEditIndex].Cells[0].FindControl("lblID")).Text);
