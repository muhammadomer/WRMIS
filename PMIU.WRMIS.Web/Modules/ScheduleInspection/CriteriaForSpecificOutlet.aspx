<%@ Page Title="Roles" MasterPageFile="~/Site.Master" Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="CriteriaForSpecificOutlet.aspx.cs" Inherits="PMIU.WRMIS.Web.Modules.ScheduleInspection.CriteriaForSpecificOutlet" %>
                                    ...
                                    <asp:GridView ID="gvOutlets" DataKeyNames="OutletID" runat="server" CssClass="table header" AutoGenerateColumns="False" AllowPaging="true"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Outlet Performance">
                                                <ItemTemplate>
                                                    <asp:HyperLink ID="hlOutletPerformance" runat="server" CssClass="btn btn-primary btn_24 outlet-performance" ToolTip="Outlet Performance" NavigateUrl='<%# String.Format("~/Modules/ScheduleInspection/AddOutletPerformanceData.aspx?OutletID={0}", Convert.ToString(Eval("OutletID"))) %>'></asp:HyperLink>
                                                </ItemTemplate>
                                                <HeaderStyle CssClass="col-md-2" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Outlet Performance History">
                                                <ItemTemplate>
                                                    <asp:HyperLink ID="hlOutletPerformanceHist" runat="server" CssClass="btn btn-primary btn_24 performance-history" ToolTip="Outlet Performance History" NavigateUrl='<%# String.Format("~/Modules/ScheduleInspection/OutletPerformanceHistory.aspx?OutletID={0}", Convert.ToString(Eval("OutletID"))) %>'></asp:HyperLink>
                                                </ItemTemplate>
                                                <HeaderStyle CssClass="col-md-2" />
                                            </asp:TemplateField>
                                        </Columns>
