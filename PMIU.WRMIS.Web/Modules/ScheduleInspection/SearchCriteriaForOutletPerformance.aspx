<%@ Page Title="Roles" MasterPageFile="~/Site.Master" Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="SearchCriteriaForOutletPerformance.aspx.cs" Inherits="PMIU.WRMIS.Web.Modules.ScheduleInspection.SearchCriteriaForOutletPerformance" %>
        ...
        <ContentTemplate>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box">
                        <div class="box-title">
                            <h3>Search Criteria For Outlet Performance</h3>
                        </div>
                                ...
                                <asp:GridView ID="gvChannels" runat="server" AutoGenerateColumns="False" EmptyDataText="No Channel is found for the given criteria"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Channel Outlets in Sections">
                                            <ItemTemplate>
                                                <asp:HyperLink ID="hlAssociation" runat="server" CssClass="btn btn-primary btn_24 outlet" ToolTip="Outlets" NavigateUrl='<%# String.Format("~/Modules/ScheduleInspection/CriteriaForSpecificOutlet.aspx?ChannelID={0}", Convert.ToString(Eval("ID"))) %>'></asp:HyperLink>
                                            </ItemTemplate>
                                            <HeaderStyle CssClass="col-md-2" />
                                        </asp:TemplateField>
