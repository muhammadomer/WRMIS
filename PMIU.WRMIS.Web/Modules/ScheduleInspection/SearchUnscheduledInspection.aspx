<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SearchUnscheduledInspection.aspx.cs" Inherits="PMIU.WRMIS.Web.Modules.ScheduleInspection.SearchUnscheduledInspection" %>
        ...
        <ContentTemplate>
            <div class="row">
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-title">
                            <h3>Search Criteria for Unscheduled Inspection</h3>
                        </div>
                        <div class="box-content" id="divMain" runat="server">
                            <div class="form-horizontal">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="fnc-btn">
                                            <asp:Button ID="btnSearch" CssClass="btn btn-primary" Text="Search Channel" runat="server" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="table-responsive">
                                <asp:GridView ID="gvChannels" runat="server" AutoGenerateColumns="False" EmptyDataText="No record found"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Channel Outlets in Section">
                                            <ItemTemplate>
                                                <asp:HyperLink ID="hlChannelOutlets" runat="server" CssClass="btn btn-primary btn_24 outlet" ToolTip="Outlets" NavigateUrl='<%# String.Format("~/Modules/DailyData/CriteriaForSpecificOutlet.aspx?ChannelID={0}", Convert.ToString(Eval("ID"))) %>'></asp:HyperLink>
                                            </ItemTemplate>
                                            <HeaderStyle CssClass="col-md-2" />
                                        </asp:TemplateField>
                                    </Columns>
