<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddFFP.aspx.cs" Inherits="PMIU.WRMIS.Web.Modules.FloodOperations.FFP.AddFFP" %>

<%@ MasterType VirtualPath="~/Site.Master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <asp:HiddenField runat="server" ID="hdnFFPID" Value="0" />
    <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional" runat="server" RenderMode="Inline">
        <ContentTemplate>
            ...
            <div class="box">
                <div class="box-title">
                    <h3 runat="server" id="h3PageTitle">Add Flood Fighting Plan</h3>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="fnc-btn">
                                    ...
                                    <asp:HyperLink ID="hlBack" runat="server" NavigateUrl="~/Modules/FloodOperations/FFP/SearchFFP.aspx" CssClass="btn">Back</asp:HyperLink>
                                </div>
                            </div>
                        </div>
                    </div>
