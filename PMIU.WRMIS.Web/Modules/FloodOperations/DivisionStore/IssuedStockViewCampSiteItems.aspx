<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="IssuedStockViewCampSiteItems.aspx.cs" Inherits="PMIU.WRMIS.Web.Modules.FloodOperations.DivisionStore.IssuedStockViewCampSiteItems" %>
        ...
        <div class="box-content">
            <div class="form-horizontal">
                    ...
                    <div class="col-md-6 ">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8 col-lg-6 controls">
                                <asp:DropDownList ID="ddlItemCategory" runat="server" OnSelectedIndexChanged="ddlItemCategory_SelectedIndexChanged" CssClass="required form-control" required="true"  AutoPostBack="True"></asp:DropDownList>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="table-responsive">
                    <br />
                    <asp:GridView ID="gvItems" runat="server" DataKeyNames="ItemId,ItemName,IssuedQty,QuantityAvailableInStore,AvailableIssuedCount"
