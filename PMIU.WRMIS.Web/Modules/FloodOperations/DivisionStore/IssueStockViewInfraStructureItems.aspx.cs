...
{
    public partial class IssueStockViewInfraStructureItems : BasePage
    {
        ...
        private void BindItemsGridView()
        {
            try
            {
                DataSet DS = new DivisionStoreBLL().DSIssuedStockViewInfraStructure(DivisionID, SelectedYear, Convert.ToInt64(StructureTypeID), Convert.ToInt64(StructureID), Convert.ToInt64(StockType), Convert.ToInt64(ddlItemCategory.SelectedValue));
                ...
                //    AvailableIssuedCount = dataRow.Field<Int64?>("AvailableIssuedCount"),
