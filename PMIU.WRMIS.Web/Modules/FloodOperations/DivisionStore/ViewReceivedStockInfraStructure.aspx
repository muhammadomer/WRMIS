<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewReceivedStockInfraStructure.aspx.cs" Inherits="PMIU.WRMIS.Web.Modules.FloodOperations.DivisionStore.ViewReceivedStockInfraStructure" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box">
        <div class="box-title">
            <h3 runat="server" id="h3PageTitle">Infrastructure Returned Items</h3>
        </div>
                ...
                <div class="table-responsive">
                    ...
                    <asp:GridView ID="gvItems" runat="server" DataKeyNames="ItemId,ItemName,AvailableIssuedCount"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Quantity Issued at Infrastructure">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Quantity Received from Infrastructure">
                                <ItemTemplate>
