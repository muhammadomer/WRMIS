<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Entitlement.aspx.cs" Inherits="PMIU.WRMIS.Web.Modules.EntitlementDelivery.Entitlement" MaintainScrollPositionOnPostback="true" %>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                <div class="box-title">
                    <h3>
                        <asp:Literal ID="litTitle" runat="server" Text="Entitlements" />
                    </h3>
                </div>
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:HiddenField ID="hdnSelectedYearPercentage" runat="server" Value='<%# Eval("SelectedYearPercentage") %>' />
                                                    </ItemTemplate>
                                                    <FooterTemplate>
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView ID="gvKharifAverage" runat="server" AutoGenerateColumns="False" EmptyDataText="No record found"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>
                                                        <asp:RadioButton ID="rbEKSYear" runat="server" style="float:right; margin-left:5px;" CssClass="control-label" GroupName="EKEntitlement" OnCheckedChanged="rbEKSYear_CheckedChanged" AutoPostBack="true"  />
                                                        <asp:DropDownList CssClass="form-control required" style="float:right;" ID="ddlEKSelectedYear" width="55%" runat="server" TabIndex="5" required="true" OnSelectedIndexChanged="ddlEKSelectedYear_SelectedIndexChanged" AutoPostBack="true" />
                                                        <asp:Label ID="hlblEKSYearMAF" runat="server" style="float:right;margin-right : 5px" CssClass="control-label" Text="EK Year"/>
                                                        <div style="clear:right;"></div>
                                                    </HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblEKSYearMAF" runat="server" CssClass="control-label" Text='<%# Eval("EKSelectedYearMAF") %>'></asp:Label>
                                                        <asp:HiddenField ID="hdnEKSelectedYearPercentage" runat="server" Value='<%# Eval("EKSelectedYearPercentage") %>' />
                                                    </ItemTemplate>
                                                    <FooterTemplate>
                                                        <asp:Label runat="server" ID="lblEKSYearTotalMAF" Text="0" />
                                                    </FooterTemplate>
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>
                                                        <asp:RadioButton ID="rbLKSYear" runat="server" style="float:right; margin-left:5px;" CssClass="control-label" GroupName="LKEntitlement" OnCheckedChanged="rbLKSYear_CheckedChanged" AutoPostBack="true"  />
                                                        <asp:DropDownList CssClass="form-control required" style="float:right;" ID="ddlLKSelectedYear" width="55%" runat="server" TabIndex="5" required="true" OnSelectedIndexChanged="ddlLKSelectedYear_SelectedIndexChanged" AutoPostBack="true" />
                                                        <asp:Label ID="hlblLKSYearMAF" runat="server" style="float:right;margin-right : 5px" CssClass="control-label" Text="LK Year"/>
                                                        <div style="clear:right;"></div>
                                                    </HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblLKSYearMAF" runat="server" CssClass="control-label" Text='<%# Eval("LKSelectedYearMAF") %>'></asp:Label>
                                                        <asp:HiddenField ID="hdnLKSelectedYearPercentage" runat="server" Value='<%# Eval("LKSelectedYearPercentage") %>' />
                                                    </ItemTemplate>
                                                    <FooterTemplate>
                                                        <asp:Label runat="server" ID="lblLKSYearTotalMAF" Text="0" />
                                                    </FooterTemplate>
                                                    <HeaderStyle CssClass=" text-right" />
                                                    <ItemStyle CssClass="text-right" />
                                                    <FooterStyle CssClass="text-right text-bold" />
