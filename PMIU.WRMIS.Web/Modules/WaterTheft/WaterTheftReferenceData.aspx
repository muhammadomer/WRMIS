                            ...
                            <div class="table-responsive">
                                <div id="offenceType" runat="server">
                                    <asp:GridView ID="gvOffenceType" runat="server" DataKeyNames="ID" AutoGenerateColumns="false" AllowPaging="true" PageSize="10"
                                        ...
                                        OnPageIndexChanging="gvOffenceType_PageIndexChanging" OnRowCancelingEdit="gvOffenceType_RowCancelingEdit" OnRowEditing="gvOffenceType_RowEditing"
                                        OnRowUpdating="gvOffenceType_RowUpdating" OnRowDeleting="gvOffenceType_RowDeleting"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Type of Offence" Visible="true">
                                                ...
                                                <EditItemTemplate>
                                                    <asp:TextBox ID="txtOffenceType" runat="server" CssClass="form-control required" onfocus="this.value = this.value;" required="true" MaxLength="30" placeholder="Enter OffenceType" Text='<%# Eval("Name") %>' ClientIDMode="Static" />
                                                </EditItemTemplate>
                                            </asp:TemplateField>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label runat="server" id="lblType" class="col-sm-4 col-lg-3 control-label">Feet to be Ignored for the Water Theft Case</label>
