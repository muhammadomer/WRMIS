<%@ Page Title="" Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="AddWorkProgress.aspx.cs" Inherits="PMIU.WRMIS.Web.Modules.AssetsAndWorks.Works.AddWorkProgress" %>

<%@ MasterType VirtualPath="~/Site.Master" %>
<%@ Register Src="~/Modules/AssetsAndWorks/UserControls/WorkProgressInfo.ascx" TagPrefix="ucWPrgrsInfo" TagName="ucPrgrsInfoCntrl" %>
        ...
        <div class="col-md-12">
            <div class="box">
                ...
                <div class="box-content">
                    <ucWPrgrsInfo:ucPrgrsInfoCntrl runat="server" ID="ucInfoAdd" />
                    <div class="form-horizontal">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="col-sm-4 col-lg-3 control-label">Physical Progress (%)</label>
                                    <div class="col-sm-8 col-lg-9 controls">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="col-sm-4 col-lg-3 control-label">Financial Progress (%)</label>
                                    <div class="col-sm-8 col-lg-9 controls">
                                        <asp:TextBox CssClass="required form-control decimal2PInput" ID="txtfinancialprg" MaxLength="5" required="required" runat="server" oninput="PercentageValidation(this)"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
