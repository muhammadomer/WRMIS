<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="WorkProgessHistory.aspx.cs" Inherits="PMIU.WRMIS.Web.Modules.AssetsAndWorks.Works.WorkProgessHistory" %>

<%@ MasterType VirtualPath="~/Site.Master" %>
<%@ Register Src="~/Modules/AssetsAndWorks/UserControls/WorkProgressInfo.ascx" TagPrefix="ucCWPInfo" TagName="ucCWPInfoControl" %>
        ...
        <div class="col-md-12">
            <div class="box">
                ...
                <div class="box-content">
                    <asp:HiddenField ID="hdnAssetWorkID" Value="" runat="server" />
                            ...
                            <div class="col-md-12">
                                <div class="table-responsive">
                                    <asp:GridView ID="gvCWP" runat="server" CssClass="table header" AllowSorting="false"
                                        AutoGenerateColumns="False" EmptyDataText="No record found" GridLines="None" PageSize="10"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Financial Progress (%)">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblFinancPrg" runat="server" Text='<%# Eval("FinancialPercentage") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle CssClass="col-md-2 text-right" />
                                                <ItemStyle CssClass="text-right" />
                                            </asp:TemplateField>
