<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="OtherExpense.aspx.cs" Inherits="PMIU.WRMIS.Web.Modules.Accounts.OtherExpense" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="box">
        <div class="box-title">
            <h3>
                <asp:Literal runat="server" ID="ltlPageTitle">Add Other Expense</asp:Literal>
            </h3>
        </div>
            ...
            <div class="form-horizontal">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8 col-lg-9 controls">
                                <asp:Label ID="lblExpenseTypeName" runat="server" CssClass="control-label" Text="Other Expense" Font-Bold="true" />
                    ...
                    <div class="col-md-6" id="dvBillNo" runat="server" visible="false">
                        <div class="form-group">
                            <asp:Label ID="lblOEBillNoText" runat="server" Text="Bill No" CssClass="col-sm-4 col-lg-3 control-label" />
                            <div class="col-sm-8 col-lg-9 controls">
                                <asp:Label runat="server" ID="lblOEBillNo" CssClass="control-label" Font-Bold="true" />
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8 col-lg-9 controls">
                                <div class="input-group">
                                    ...
                                    <asp:TextBox ID="txtOEBillDate" runat="server" CssClass="form-control date-picker-user required" required="true" TabIndex="1" onkeyup="return false;" onkeydown="return false;" autocomplete="off" />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8 col-lg-9 controls">
                                <asp:TextBox runat="server" ID="txtExpenseName" CssClass="form-control required" MaxLength="50" TabIndex="2" required="true" oninput="javascript:InputWithLengthValidation(this, 3)" />
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8 col-lg-9 controls">
                                        <asp:TextBox runat="server" ID="txtOEApprovalReference" CssClass="form-control" MaxLength="150" TabIndex="3" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8 col-lg-9 controls">
                                        <asp:TextBox runat="server" ID="txtExpenseAmount" CssClass="form-control required decimal2PInput" onfocus="RemoveCommas(this);" onblur="AddCommas(this);" required="true" MaxLength="10" TabIndex="4" OnTextChanged="txtExpenseAmount_TextChanged" AutoPostBack="true" autocomplete="off" />
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <asp:Label ID="lblOEAttachBill" runat="server" Text="Attach Bill" CssClass="col-sm-4 col-lg-3 control-label" />
                            <div class="col-sm-8 col-lg-9 controls">
                                <div class="input-group">
                                    <fup:FileUploadControl runat="server" ID="fupOEAttachBill" Size="1" tabindex="5" Name="FormCtrl" />
                                </div>
                                <div>
                                    <fup:FileUploadControl runat="server" ID="fupOEAttachBillEdit" Size="0" />
                                </div>
                            </div>
                        </div>
                    </div>
