<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewEntitlement.aspx.cs" Inherits="PMIU.WRMIS.Web.Modules.PublicWebSite.ViewEntitlement" %>
                ...
                <div class="box-content">
                    <div class="row">
                        <div class="col-md-12 text-left">
                            <h3>
                                <asp:Label ID="lblMainDesc" runat="server" Text="" Font-Bold="true" />
                            </h3>
                        </div>
                    </div>
                    <br />
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <asp:Label ID="lblEntitlementText" runat="server" Text="" />
                        </div>
                        <div class="col-md-1 text-right">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <asp:Label ID="lblPercentChangeText" runat="server" Text=" % Change w.r.t 1977-1982:" />
                        </div>
                        <div class="col-md-1 text-right">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <asp:Label ID="lblDesignDischargeText" runat="server" Text="Design Discharge (Cusecs):" />
                        </div>
                        <div class="col-md-1 text-right">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="fnc-btn">
                                <asp:HyperLink ID="hlBack" runat="server" onclick="window.history.back()" CssClass="btn" Text="Back" />
                            </div>
                        </div>
                    </div>
                </div>
